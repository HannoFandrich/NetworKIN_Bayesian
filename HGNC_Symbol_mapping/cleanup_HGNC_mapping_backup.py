...
idmap_HGNC_Ensg_HGNC = ReadIdMapSimple("HGNC_map.txt", 8, 2, offset = 1)
MergeMap(idmap_HGNC_Ensg_HGNC, ReadIdMapSimple("HGNC_map.txt", 10, 2, offset = 1))

approved_symbol_names = set(ReadIdMapSimple("HGNC_map.txt", 2, 1, offset = 1).keys())
